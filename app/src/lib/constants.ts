 ...
 */
export const APP_DESCRIPTION = 'Live Audio Spaces, on Farcaster';
 ...
 */
export const APP_TAGS = ['spaces', 'audio', 'friends', 'conversation', 'spacecaster', 'rooms'];
 ...
 */
export const APP_BUTTON_TEXT = 'Create Room';
